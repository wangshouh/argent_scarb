...
mod ArgentAccount {
    ...
    use argent_account::{Escape, EscapeStatus, IArgentAccount, IDeprecatedArgentAccount};
    use argent_lib::{
    ...
    impl Private of PrivateTrait {
        ...
        fn assert_valid_new_owner(
            ...
            let mut message_hash = LegacyHash::hash(
            ...
            message_hash = LegacyHash::hash(message_hash, 4);
